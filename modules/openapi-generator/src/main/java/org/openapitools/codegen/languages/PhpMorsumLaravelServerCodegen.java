...
public class PhpMorsumLaravelServerCodegen extends AbstractPhpCodegen {
    ...
    public String getHelp() {
        return "Generates a PHP Morsum laravel server library.";
    }

    /**
     * Class constructor
     */
    public PhpMorsumLaravelServerCodegen() {
        super();
        ...
        embeddedTemplateDir = templateDir = "php-morsum-laravel";
        variableNamingConvention = "camelCase";

        /*
         * packPath
         */
        invokerPackage = "php-morsum-laravel";
